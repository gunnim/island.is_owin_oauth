...
namespace Umbraco.Site
{
    ...
    public class UmbracoStandardOwinStartup : UmbracoDefaultOwinStartup
    {
        public override void Configuration(IAppBuilder app)
        {
            ...
            var authOptions = new DummyAuthenticationOptions("John", "superjon")
            {
                SignInAsAuthenticationType = Constants.Security.BackOfficeExternalAuthenticationType
            };
            authOptions.SetExternalSignInAutoLinkOptions(new ExternalSignInAutoLinkOptions(autoLinkExternalAccount: true, defaultUserGroups: new string[] { "admin" }));
            authOptions.ForUmbracoBackOffice("btn-facebook", "fa-facebook");

            app
                .Use<DummyAuthenticationMiddleware>(app, authOptions)
                .UseUmbracoBackOfficeTokenAuth(new BackOfficeAuthServerProviderOptions())
            ;
